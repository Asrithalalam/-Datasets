...
🔸The goal is to analyze relationships between all features, understand patterns across species, and generate visual insights. 
...
-Using multiple visual techniques improves understanding of patterns and relationships within the data.
